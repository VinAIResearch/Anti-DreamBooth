...
def represent(
    ...
    if detector_backend != "skip":
        ...
        img_objs = [(img, img_region, 0, None, None, None)]
    # ---------------------------------

    for img, region, confidence, landmarks, angle, direction in img_objs:
...
def extract_faces(
    ...
    for img, region, confidence, landmarks, angle, direction in img_objs:
        ...
        resp_obj["facial_area"] = region
        resp_obj["confidence"] = confidence
        resp_obj["landmarks"] = landmarks
        resp_obj["angle"] = angle
        resp_obj["direction"] = direction
        resp_objs.append(resp_obj)
